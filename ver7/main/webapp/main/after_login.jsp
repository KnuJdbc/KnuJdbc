        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  mx-auto ">
              ...
              <li class="nav-item">
                <a class="nav-link" href="../search_animal/search.jsp">All ANIMAL</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../search_animal/search_img.jsp">IMAGE</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../search_animal/statistics.jsp">STATISTICS</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="../quiz_animal/Animal_quiz.jsp">QUIZ</a>
              </li>
            <form class="form-inline" action="../search_animal/get_info.html">
...
Degradation of important Angelshark habitat through unsustainable coastal development and coastal infrastructure is of concern, especially in nursery areas identified in shallow inshore waters   </br>     </br>          <div class="options">
      ...
      <div class="btn-box">
        <a href="../search_animal/get_info.html">
          View More
        </a>
      </div>
    </div>
...
It provides information about range, population size, habitat and ecology, use and/or trade, threats, and conservation actions that will help inform necessary conservation decisions.
           ...
           <form name="user_form" method=post action="Donate.jsp">
            <button type="submit" value="Donate">Donate
...
That is still 28% of all assessed species.            </p>
      ...
      <div class="footer-info">
        <p>
          &copy; <span id="displayYear"></span> 
            ...
            <button type="submit" value="회원 탈퇴"> 회원 탈퇴
